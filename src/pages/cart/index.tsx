...
export default function CartPage() {
  ...
  const { addresses,getAddress , productToCart, productPersonalize } = ContextApp()
  ...
  return (
    <div className=" max-w-[1100px] m-auto">
      <div className="w-full flex flex-col items-center justify-center mb-10">
        ...
        <Summary tax={getAddress ? getAddress.neighborhood.tax : addresses[0].neighborhood.tax}/>

        <CardAddress />

          {addresses.length > 0 && 
            <NavLink className={'w-full flex items-center justify-center'} to={"/payment"}>
