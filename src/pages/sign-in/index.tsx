...
export default function SignIn() {
    ...
    const handleSignIn = async (data: CreateCustomerFormData) => {
        try {
            ...
            // setCookie(undefined, 'dev-cash.token', access_token, {
    ...
    return (
        <main className='mt-40 flex items-center justify-center'>
            ...
            >
                ...
                <input
                    {...register('email')}
                    className="w-10/12 p-4 mb-4 rounded  border border-gray-400 text-sm text-gray-100 placeholder:text-gray-500"
                    type="text"
